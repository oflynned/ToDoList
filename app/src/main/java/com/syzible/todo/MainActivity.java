...
public class MainActivity extends AppCompatActivity {
    ...
    public void setDateOrdered(boolean dateOrdered) {
        this.dateOrdered = dateOrdered;
    }

    public boolean isDateOrdered() {
        return dateOrdered;
    }

    public void setCategoryOrdered(boolean categoryOrdered) {
    ...
    public void setDescriptionOrdered(boolean descriptionOrdered) {
        this.descriptionOrdered = descriptionOrdered;
    }

    public boolean isDescriptionOrdered() {
        return descriptionOrdered;
    }
